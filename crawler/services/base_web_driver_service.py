...
# class MyFirefoxWebDriver(RequestMixin, Firefox):
# 	def t(self):
# 		self.
...
class BaseWebDriverService(object):
	...
	# _user_agent = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.1 Safari/605.1.15'
